...
$packageArgs = @{
    ...
    Url64            = 'https://github.com/graalvm/graalvm-ce-builds/releases/download/vm-21.1.0/graalvm-ce-java11-windows-amd64-21.1.0.zip'
    Checksum64       = '37d91bad975a644ffb9e8fa8c74dec462f84706a1455a8436b5746c6b7b70652'
