...
Install-ChocolateyEnvironmentVariable 'JAVA_HOME' $targetDir\jdk-12.0.0 'Machine'
# The full path instead of the %JAVA_HOME% is needed so it can be removed with the Chocolatey Uninstall
Install-ChocolateyPath 'C:\Program Files\OpenJDK\jdk-12.0.0\bin' -PathType 'Machine'
